...
const elH2_RoomName = document.querySelector("section.roomDetail_sec1 > h2"),
  elDiv_info = document.querySelector(
    "section.roomDetail_sec1 > .infoTxtWrapper"
  ),
  elCode = elDiv_info.querySelectorAll("li>code"),
  elUl_main = document.querySelector("div.main > ul.swiper-wrapper"),
  elUl_slide = document.querySelector(
    "div.otherRoomsSwiper > ul.swiper-wrapper"
  );
      ...
      on: {
        slideChange: function (e) {
          const elPage = document.querySelector(
              "section.roomDetail_sec2 .pagination"
            ),
